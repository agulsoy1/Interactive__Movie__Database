      ...
      <div className="movie__detail">
        ...
        <div className="card__wrapper">
          ...
          <div className="card__info">
            <div className="movie__card--title-wrapper">
              <h1 className="movie__card--title">{movie?.Title}</h1>
            </div>
            <div className="movie__card--info-wrapper">
              <h2 className="movie__card--info movie__card--director">
                Director: <span className="white">{`${movie?.Director}`}</span>
              </h2>
              <h3 className="movie__card--info movie__card--genre">
                Genre: <span className="white">{`${movie?.Genre}`}</span>
              </h3>
              <h3 className="movie__card--info movie__card--released">
                Release Date:{" "}
              ...
              <h4 className="movie__card--info movie__card--rating">
                Rated: <span className="white">{`${movie?.Rated}`}</span>
              </h4>
              <h4 className="movie__card--info movie__card--actors">
                Cast: <span className="white">{`${movie?.Actors}`}</span>
              </h4>
              <h5 className="movie__card--info movie__card--plot">
